...
// import { useTheme } from '../../app/contexts/ThemeContext';
// import colors from '../../shared/ui/constants/baseStyles';
// import { useComicbook } from '../../features/comicbook-info/model/hooks/useComicbook';
// import ComicbookInfo from '../../features/comicbook-info/ui/ComicbookInfo';

// type ComicbookInfoBlockProps = {
//   comicbookId : number,
//   navigation: any
// }

// const ComicbookInfoBlock: React.FC<ComicbookInfoBlockProps> = ({comicbookId, navigation}) => {
//   const { theme } = useTheme();
//   const activeColors = colors[theme.mode];
//   const {comicbook, loading, getComicbook} = useComicbook();

//   useEffect(() => {3
//     getComicbook(comicbookId);
//   }, [comicbookId]);
...
//   return (
//     <View style={[styles.container, { backgroundColor: activeColors.primary }]}>
//       <ComicbookInfo comicbook={comicbook} navigation={navigation} />
//     </View>
//   );
// };
...
// export default ComicbookInfoBlock;
...
import { useComicbook } from '../../features/comicbook-info/model/hooks/useComicbook';
import ComicbookInfo from '../../features/comicbook-info/ui/ComicbookInfo';
import { ComicbookDetails } from '../../features/comicbook-info/model/types';
type ComicbookInfoBlockProps = {
  comicbookId : number,
  navigation: any;
  isFavorite: boolean;
...
const ComicbookInfoBlock: React.FC<ComicbookInfoBlockProps> = ({comicbookId, navigation, isFavorite, onToggleFavorite}) => {
  const { theme } = useTheme();
  const activeColors = colors[theme.mode];
  const {comicbook, loading, getComicbook} = useComicbook();
  ...
  return (
    <View style={[styles.container, { backgroundColor: activeColors.primary }]}>
      <ComicbookInfo comicbook={comicbook}  navigation={navigation} isFavorite={isFavorite} onToggleFavorite={onToggleFavorite} />
    </View>
  );
};
