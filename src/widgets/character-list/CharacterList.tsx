...
import { CharacterCard } from '../../features/character-list/ui/Character/CharacterCard';
import { useCharacters } from '../../features/character-list/model/hooks/useCharacters';
import SkeletonCard  from '../../shared/ui/components/SkeletonCard/SkeletonCard';
import colors from '../../shared/ui/constants/baseStyles';
import { useTheme } from '../../app/contexts/ThemeContext';
import { Character } from '../../features/character-list/model/types';
const SKELETON_ITEMS = Array(12).fill(null);
